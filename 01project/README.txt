...
The code base has been refactored to be more object oriented. The primary files consist of:

  - raytrace.cpp: Contains the main function as well as our ray tracer
  - scene.h: Embodies the environment & primitives for the raytracer to work on
  - parse.cpp: parses the input file and returns a Scene object
  - 

Supplementary files have been created such as our Vector, RGB, Material, and Primitive implementations.
